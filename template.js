...
exports.template = function(grunt, init, done) {
    ...
    var thirdModuleMapping = {
        ...
        "mlg-swipe-track" : "mlgSwipeTrack",
        "angular-jm-unique-by-key" : "jmUniqueByKey",
        "angular-button-indicator" : "jm-button-indicator"
    };
    ...
    var options = {
        ...
        thirdModules : ["mlg-wms-auth", "angular-button-indicator","mlg-swipe-track","angular-jm-unique-by-key"]
    };
        ...
        if (mode === "Advanced") {
            ...
            inquirer.prompt([
                ...
                },
                {
                    ...
                    choices: ["mlg-wms-auth", "angular-button-indicator", "mlg-swipe-track","angular-jm-unique-by-key"],
                    default: ["mlg-wms-auth", "angular-button-indicator", "mlg-swipe-track","angular-jm-unique-by-key"]
                },
                {
                    type: "confirm",
                    name: "test",
